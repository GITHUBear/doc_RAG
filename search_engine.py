...
class MilvusSearchEngine:
    ...
    def _create_collections(self):
        ...
        if self.client.has_collection(collection_name=self.collection_corpus):
            ...
            corpus_fields = [
                ...
                FieldSchema(name="enhause_title_sparse_vec", dtype=DataType.SPARSE_FLOAT_VECTOR),
            ]
    ...
    def add_chunks(self, chunks: List[Chunk]):
        ...
        entities = []
        for chunk, ctt_dense, ctt_sparse, title_dense, title_sparse in zip(chunks, contents_embds['dense_vecs'], contents_embds['lexical_weights'], chunk_title_embds['dense_vecs'], chunk_title_embds['lexical_weights']):
            content = chunk.text
